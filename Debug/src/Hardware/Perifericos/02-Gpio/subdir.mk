...
CPP_SRCS += \
../src/Hardware/Perifericos/02-Gpio/Gpio.cpp 

CPP_DEPS += \
./src/Hardware/Perifericos/02-Gpio/Gpio.d 

OBJS += \
./src/Hardware/Perifericos/02-Gpio/Gpio.o 


# Each subdirectory must supply rules for building sources it contributes
src/Hardware/Perifericos/02-Gpio/%.o: ../src/Hardware/Perifericos/02-Gpio/%.cpp src/Hardware/Perifericos/02-Gpio/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-Hardware-2f-Perifericos-2f-02-2d-Gpio

clean-src-2f-Hardware-2f-Perifericos-2f-02-2d-Gpio:
	-$(RM) ./src/Hardware/Perifericos/02-Gpio/Gpio.d ./src/Hardware/Perifericos/02-Gpio/Gpio.o

.PHONY: clean-src-2f-Hardware-2f-Perifericos-2f-02-2d-Gpio
